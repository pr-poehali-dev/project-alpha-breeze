...
export function ContactHeader() {
  return (
    <>
      <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mb-6 text-sm text-gray-100 font-medium">
      ...
      <div className="flex items-center justify-center gap-2 mb-8 p-4 bg-blue-500/10 rounded-lg border border-blue-400/20">
        ...
        <p className="text-base sm:text-lg font-semibold text-gray-100 text-center">
